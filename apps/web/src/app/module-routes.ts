...
export const moduleRoutes = [
  ...
  { label: "Keywords & Rankings", path: "/keywords-rank", icon: "key", description: "Kuratiertes Keyword-Universum mit Rankings, Sichtbarkeit und SERP-Analyse.", status: "active", plannedWave: 3, section: "Analyse", tier: "basic", dataStatus: "demo", dataNote: "Rankings/SERP sind Demo-Daten (SERP-Provider-Stub). Echte Werte folgen mit verbundener Datenquelle." },
  ...
  { label: "Content Workspace", path: "/content-workspace", icon: "description", description: "Refresh-Kandidaten, Content-Score und manuell editierbare Content-Briefs mit Ticket-/PR-Übergabe.", status: "active", plannedWave: 4, section: "Wachstum", tier: "basic", dataStatus: "demo", dataNote: "Briefs und interne Link-Vorschläge sind belastbar; Refresh-Signale (Klicks-Trend, Content-Score) sind Demo-Daten, bis ein GSC-Connector verbunden ist." },
  ...
  { label: "Einstellungen", path: "/settings", icon: "settings", description: "Connectors, Datenquellen und Projekt-Konfiguration.", status: "active", plannedWave: 1, section: "System", tier: "basic", dataStatus: "demo", dataNote: "Connector-Werte (GSC/GA4) sind Demo-Platzhalter, bis echte Zugänge verbunden sind." }
