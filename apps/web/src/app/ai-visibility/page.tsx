      ...
      <div className="ai-root">
        <header className="page-header">
          <div className="page-header__titles">
            ...
            <p className="page-header__purpose">
              Wird Ihre Website genannt, wenn Leute ChatGPT, Gemini &amp; Co. fragen — und sind Ihre
              Seiten dafür gut aufbereitet?
            </p>
          </div>
        ...
        <p className="ai-classE-notice" role="note">
          ...
          <span className="ai-classE-notice__text">
            KI-Sichtbarkeit beruht auf{" "}
            <TermTooltip term="Evidenz / Konfidenz (A–E)">LLM-Interpretation (Klasse E)</TermTooltip>{" "}
            — ein <strong>Signal, kein Beleg</strong>. Nicht als Evidenz für Entscheidungen verwenden.
          </span>
        </p>
        ...
        {/* AEO-Analyse (Class A) + Proposals — demoted, side-by-side. */}
