...
- The crawler worker loop is not started by Vercel. Run `@seo-tool/crawler` as the separate worker instance described above; API endpoints remain available under `/api/backend/*`.
